                                                                  ...
                                                                  child:
                                                                      IconButton(
                                                                          onPressed:
                                                                              () {
                                                                            int quantity =
                                                                                int.parse(snapshot.child(Constants.dQuantity).value.toString());
                                                                            int price =
                                                                                int.parse(snapshot.child(Constants.dSPrice).value.toString());
                                                                            decrementQuantity(
                                                                                quantity,
                                                                                price,
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => MyStepperCheckOutPage(
                                id: orderid.toString(), total: total),
                          ));
                        },
